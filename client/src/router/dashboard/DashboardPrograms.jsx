                      ...
                      <CardContent className="p-6 flex flex-col justify-between h-full space-y-4">
                        ...
                        <div className="pt-3 border-t border-secondary-100 space-y-3">
                          ...
                          <Link
                            ...
                            className="inline-flex items-center justify-center w-full px-4 py-2 text-xs font-semibold text-primary-700 bg-primary-50 rounded-xl hover:bg-primary-100 hover:text-primary-800 transition-colors text-center"
                          >
                            حجز حصة استشارية
                          </Link>
                        </div>
